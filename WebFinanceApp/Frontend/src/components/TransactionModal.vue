...
<style scoped>
.tm__backdrop { position: fixed; inset: 0; display: grid; place-items: center; background: rgba(0,0,0,0.45); z-index: 9997; padding:16px; }
.tm__card { width: 100%; max-width: 900px; }
.tm__title { margin: 0 0 6px 0; }
.tm__subtitle { margin: 0 0 12px 0; color: var(--muted); }
.tm__actions { display: flex; gap: 12px; justify-content: flex-end; }
</style>