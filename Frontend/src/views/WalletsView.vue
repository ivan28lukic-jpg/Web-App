    ...
    <div class="card" style="overflow:auto;">
      <header style="display:flex; align-items:center; justify-content:space-between; gap:6px; margin-bottom:12px;">
        ...
        <div style="display:flex; gap:8px; align-items:center;">
          ...
          <!-- Checkbox za prikaz arhiviranih novčanika -->
...
const includeArchived = ref(false); // NOVO: checkbox state
...
async function reload() {
  await wallets.fetch({ search: search.value, page: 0, size: 100, includeArchived: includeArchived.value });
}
